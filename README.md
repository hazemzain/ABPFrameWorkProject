...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 696528d6-8543-4cda-9633-c7ed5e226b28
```

> `696528d6-8543-4cda-9633-c7ed5e226b28` is the password of the certificate, you can change it to any password you want.
